<template>
  <TemplateComponent>
    ...
    <template #HeaderRight>
      <a-button type="primary" @click="updateVisible = true; title = '新增类型';cloneDeepData={}">新增标签</a-button>
    ...
    <template #Main>
      ...
      <notify-confirm type="danger" :title="delTitle" :isShow="isDelTips" @cancel="handleDelCancel"
        ...
        <CategoryModal :visible="updateVisible" :title="title" :initialData="cloneDeepData" @cancel="handleCancel"></CategoryModal>
    </template>
  </TemplateComponent>
</template>
