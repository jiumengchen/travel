<template>
  <TemplateComponent>
    ...
    <template #Main>
      ...
      <DestModal :visible="updateVisible" @cancel="updateVisible = false" :title="title"></DestModal>
      <ViewDestDetail :visible="viewVisible" @cancel="viewVisible = false"></ViewDestDetail>
    </template>
  </TemplateComponent>
</template>
